...
{
    /// <summary>
    /// Represents an undirected and weighted adjacency list graph with optimized amortized O(1) edge lookup and removal.
    /// </summary>
    ...
    public class WeightedALGraph<TVertex, TWeight> : IWeightedGraph<TVertex, TWeight>
        ...
        where TWeight : IComparable<TWeight>
    {
        ...
        /// <summary>
        /// Determines whether the <see cref="WeightedALGraph{TVertex, TWeight}"/> is directed.
        /// </summary>
        public bool IsDirected { get { return false; } }

        /// <summary>
        /// Deteremines whether the <see cref="WeightedALGraph{TVertex, TWeight}"/> is weighted.
        /// </summary>
        public bool IsWeighted { get { return true; } }

        /// <summary>
        /// Gets the number of edges in the <see cref="WeightedALGraph{TVertex, TWeight}"/>.
        /// </summary>
        public int EdgesCount { get; internal set; }

        /// <summary>
        /// Gets the number of vertices in the <see cref="WeightedALGraph{TVertex, TWeight}"/>.
        /// </summary>
        public int VerticesCount { get; internal set; }

        /// <summary>
        /// Gets the vertices in the <see cref="WeightedALGraph{TVertex, TWeight}"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets the vertices in the <see cref="WeightedALGraph{TVertex, TWeight}"/> in sorted ascending order.
        /// </summary>
        ...
        /// <summary>
        /// Gets the edges in the <see cref="WeightedALGraph{TVertex, TWeight}"/>. For each edge in the graph returns two <see cref="WeightedEdge{TVertex, TWeight}"/> objects with swapped source and destination vertices.
        /// </summary>
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="WeightedALGraph{TVertex, TWeight}"/>.
        /// </summary>
        public WeightedALGraph()
        {
        ...
        /// <summary>
        /// Adds an edge defined by the given vertices to the <see cref="WeightedALGraph{TVertex, TWeight}"/> with weight being the <see cref="TWeight"/> default value of the <see cref="WeightedALGraph{TVertex, TWeight}"/>. If the vertices are not present in the graph they will be added.
        /// </summary>
        ...
        /// <summary>
        /// Adds an edge defined by the given vertices to the <see cref="WeightedALGraph{TVertex, TWeight}"/> with the given weight. If the vertices are not present in the graph they will be added.
        /// </summary>
        /// <param name="firstVertex">The first vertex.</param>
        /// <param name="secondVertex">The second vertex.</param>
        ...
        public bool AddEdge(TVertex firstVertex, TVertex secondVertex, TWeight weight)
        {
            ...
            if (!AddVertex(firstVertex))
                if (adjacencyList[firstVertex].ContainsKey(secondVertex))// if the vertices are connected
                    return false;// we return false

            // Here the firstVertex is in the graph, so we connect it with the second
            adjacencyList[firstVertex].Add(secondVertex, weight);

            // Add the other way around. Graph is not directed.
            AddVertex(secondVertex);
            adjacencyList[secondVertex].Add(firstVertex, weight);
        ...
        /// <summary>
        /// Adds a vertex to the <see cref="WeightedALGraph{TVertex, TWeight}"/>.
        /// </summary>
        ...
        /// <summary>
        /// Adds the specified collection of vertices to the <see cref="WeightedALGraph{TVertex, TWeight}"/>. If some of the vertices are already in the graph exception is not thrown.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether the edge is presented in the <see cref="WeightedALGraph{TVertex, TWeight}"/>.
        /// </summary>
        /// <param name="firstVertex">The first vertex of the edge.</param>
        /// <param name="secondVertex">The second vertex of the edge.</param>
        /// <returns>Returns true if the edge is presented in the <see cref="WeightedALGraph{TVertex, TWeight}"/>; false otherwise.</returns>
        public bool ContainsEdge(TVertex firstVertex, TVertex secondVertex)
        {
            if (!adjacencyList.ContainsKey(firstVertex)) return false;

            return adjacencyList[firstVertex].ContainsKey(secondVertex);
        }

        /// <summary>
        /// Determines whether the vertex is presented in the <see cref="WeightedALGraph{TVertex, TWeight}"/>.
        /// </summary>
        /// <param name="vertex">The vertex to see if presented in the <see cref="WeightedALGraph{TVertex, TWeight}"/>.</param>
        /// <returns>Returns true if the vertex is presented in the <see cref="WeightedALGraph{TVertex, TWeight}"/>; false otherwise.</returns>
        ...
        /// <summary>
        /// Updates the weight of the edge defined by the given vertices in the <see cref="WeightedALGraph{TVertex, TWeight}"/>.
        /// </summary>
        /// <param name="firstVertex">The first vertex.</param>
        /// <param name="secondVertex">The second vertex.</param>
        ...
        {
            if (!adjacencyList[firstVertex].ContainsKey(secondVertex)) return false;

            adjacencyList[firstVertex][secondVertex] = weight;
            adjacencyList[secondVertex][firstVertex] = weight;
            return true;
        }

        /// <summary>
        /// Gets the weight of the edge defined by the given vertices in the <see cref="WeightedALGraph{TVertex, TWeight}"/>.
        /// </summary>
        /// <param name="firstVertex">The first vertex.</param>
        /// <param name="secondVertex">The second vertex.</param>
        ...
        public bool TryGetEdgeWeight(TVertex firstVertex, TVertex secondVertex, out TWeight weight)
        {
            ...
            weight = adjacencyList[firstVertex][secondVertex];
            return true;
        }

        /// <summary>
        /// Removes the edge defined by the given vertices from the <see cref="WeightedALGraph{TVertex, TWeight}"/>.
        /// </summary>
        /// <param name="firstVertex">The first vertex.</param>
        /// <param name="secondVertex">The second vertex.</param>
        ...
        /// <summary>
        /// Removes the given vertex from the <see cref="WeightedALGraph{TVertex, TWeight}"/>.
        /// </summary>
        ...
        public bool RemoveVertex(TVertex vertex)
        {
            ...
            {
                adjacencyList[destinationVertex.Key].Remove(vertex);
                EdgesCount--;
            }
            // Remove vertex
        ...
        /// <summary>
        /// Returns the degree of the given vertex presented in the <see cref="WeightedALGraph{TVertex, TWeight}"/>.
        /// </summary>
        ...
        /// <summary>
        /// Removes all edges and vertices from the <see cref="WeightedALGraph{TVertex, TWeight}"/>.
        /// </summary>
        public void Clear()
        {
            adjacencyList.Clear();
        ...
        /// <summary>
        /// Breadth-first search of the <see cref="WeightedALGraph{TVertex, TWeight}"/> with sorted levels. Returns <see cref="IEnumerable{T}"/> of the vertices.
        /// </summary>
        ...
        /// <summary>
        /// Breadth-first search of the <see cref="WeightedALGraph{TVertex, TWeight}"/> with sorted levels. Returns <see cref="IEnumerable{T}"/> of <see cref="WeightedEdge{TVertex, TWeight}"/> representing the edges of the graph.
        /// </summary>
        /// <param name="vertex">The vertex from which the breadth-first search starts.</param>
        ...
        /// <summary>
        /// Depth-first search of the <see cref="WeightedALGraph{TVertex, TWeight}"/> with sorted levels. Returns <see cref="IEnumerable{T}"/> of the vertices.
        /// </summary>
        ...
        /// <summary>
        /// Depth-first search of the <see cref="WeightedALGraph{TVertex, TWeight}"/> with sorted levels. Returns <see cref="IEnumerable{T}"/> of <see cref="WeightedEdge{TVertex, TWeight}"/> representing the edges of the graph.
        /// </summary>
        /// <param name="vertex">The vertex from which the depth-first search starts.</param>
        /// <returns>.Returns <see cref="IEnumerable{T}"/> of <see cref="WeightedEdge{TVertex, TWeight}"/> representing the edges of the graph.</returns>
