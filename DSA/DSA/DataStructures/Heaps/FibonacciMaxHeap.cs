...
namespace DSA.DataStructures.Heaps
{
        ...
        where T : IComparable<T>
    {
        ...
        /// </summary>
        internal FibonacciNode<T> maxNode;
        ...
        /// <summary>
        /// Merging two <see cref="FibonacciNode{T}"/> lists into one returning the node with the bigger value.
        /// </summary>
        ...
        public T PopMax()
        {
            ...
            // Get next tree root
            FibonacciNode<T> nextNode = maxCopy.Next == maxCopy ? null : maxCopy.Next;
