...
namespace DSA.DataStructures.Queues
{
    ...
    {
        /// <summary>
        /// The backing <see cref="ArrayList{T}"/> containing the elements of the <see cref="MaxPriorityQueue{TPriority, TValue}"/>.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether the <see cref="MaxPriorityQueue{TPriority, TValue}"/> is empty.
        /// </summary>
        ...
        /// <summary>
        /// Heapifies the given <see cref="IEnumerable{T}"/> collection. Overrides the current <see cref="MaxPriorityQueue{TPriority, TValue}"/>.
        /// </summary>
        ...
        /// <summary>
        /// Merges the elements of the <see cref="MaxPriorityQueue{TPriority, TValue}"/> with the other given <see cref="MaxPriorityQueue{TPriority, TValue}"/>.
        /// </summary>
        /// <param name="otherMaxPriorityQueue">The other <see cref="MaxPriorityQueue{TPriority, TValue}"/> used for merging.</param>
        public void Merge(MaxPriorityQueue<TPriority, TValue> otherMaxPriorityQueue)
        {
            for (int i = 0; i < otherMaxPriorityQueue.Count; i++)
            {
                var kvp = otherMaxPriorityQueue.array[i];
                Enqueue(kvp.Key, kvp.Value);
            }
        }

        /// <summary>
        /// Enqueues an element to the <see cref="MaxPriorityQueue{TPriority, TValue}"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets the first element of the <see cref="MaxPriorityQueue{TPriority, TValue}"/>.
        /// </summary>
        /// <returns>Returns a <see cref="KeyValuePair{TKey, TValue}"/> (with the first element as value and its priority as key) from the <see cref="MaxPriorityQueue{TPriority, TValue}"/>.</returns>
        ...
        /// <summary>
        /// Removes and returns the first element of the <see cref="MaxPriorityQueue{TPriority, TValue}"/>.
        /// </summary>
        /// <returns>Returns a <see cref="KeyValuePair{TKey, TValue}"/> (with the first element as value and its priority as key) which was removed from the <see cref="MaxPriorityQueue{TPriority, TValue}"/>.</returns>
        ...
        /// <param name="value">The value to replace the first element of the <see cref="MaxPriorityQueue{TPriority, TValue}"/>.</param>
        ...
        /// <summary>
        /// Removes all elements from the <see cref="MaxPriorityQueue{TPriority, TValue}"/>.
        /// </summary>
        public void Clear()
        {
        ...
        /// <summary>
        /// Copies the elements of the <see cref="MaxPriorityQueue{TPriority, TValue}"/> to a new array.
        /// </summary>
        /// <returns>An array containing copies of the elements of the <see cref="MaxPriorityQueue{TPriority, TValue}"/>.</returns>
