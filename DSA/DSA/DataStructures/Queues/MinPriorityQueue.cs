...
namespace DSA.DataStructures.Queues
{
        ...
        where TPriority : IComparable<TPriority>
    {
        ...
        /// <summary>
        /// The comparer of the elements in the <see cref="MinPriorityQueue{TPriority, TValue}"/>.
        /// </summary>
        ...
        /// </summary>
        public MinPriorityQueue() : this(4, null) { }
        ...
        /// </summary>
        /// <param name="comparer">The comparer of the elements in the <see cref="MinPriorityQueue{TPriority, TValue}"/>.</param>
        public MinPriorityQueue(Comparer<TPriority> comparer) : this(4, comparer) { }
        ...
        /// <param name="capacity">The capacity for the underlying <see cref="ArrayList{T}"/>.</param>
        /// <param name="comparer">The comparer of the elements in the <see cref="MinPriorityQueue{TPriority, TValue}"/>.</param>
        public MinPriorityQueue(int capacity, Comparer<TPriority> comparer)
        {
        ...
        private void NodeHeapifyDown(int nodeIndex)
        {
            ...
            while (leftChildIndex < array.Count)
            {
                ...
                if (rigthChildIndex < array.Count)// needed checking if there is a right node also
                    if (comparer.Compare(array[rigthChildIndex].Key, array[smallestNodeIndex].Key) < 0)
                        smallestNodeIndex = rigthChildIndex;

                // compare left child with the smallest node(current node or right child)
                if (comparer.Compare(array[leftChildIndex].Key, array[smallestNodeIndex].Key) < 0)
