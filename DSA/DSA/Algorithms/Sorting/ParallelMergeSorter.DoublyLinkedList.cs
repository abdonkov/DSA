...
{
    /// <summary>
    /// Static class containing extension methods for parallel merge sort.
    /// </summary>
    public static partial class ParallelMergeSorter
    {
        ...
        public static DoublyLinkedList<T> ParallelMergeSort<T>(this DoublyLinkedList<T> list)
        {
        ...
        /// <param name="list">The <see cref="DoublyLinkedList{T}"/> containing the elements for sorting.</param>
        /// <returns>Returns the given <see cref="DoublyLinkedList{T}"/> when sorted.</returns>
        public static DoublyLinkedList<T> ParallelMergeSortDescending<T>(this DoublyLinkedList<T> list)
        {
        ...
        /// <returns>Returns the given <see cref="DoublyLinkedList{T}"/> when sorted.</returns>
        public static DoublyLinkedList<T> ParallelMergeSort<T>(this DoublyLinkedList<T> list, IComparer<T> comparer)
        {
            if (list.Count > 0)
        ...
        /// or null to use the default comparer <see cref="Comparer{T}.Default"/>.</param>
        /// <returns>Returns the given <see cref="DoublyLinkedList{T}"/> when sorted.</returns>
        public static DoublyLinkedList<T> ParallelMergeSortDescending<T>(this DoublyLinkedList<T> list, IComparer<T> comparer)
        {
            if (list.Count > 0)
        ...
        /// <summary>
        /// Parallel algorithm. In-place sorting of the given <see cref="DoublyLinkedList{T}"/> elements. Used for ascending sort.
        /// </summary>
        /// <typeparam name="T">The data type of the <see cref="DoublyLinkedList{T}"/>.</typeparam>
        /// <param name="list">The <see cref="DoublyLinkedList{T}"/> containing the elements for sorting.</param>
        ...
        private static void ParallelSplitMerge<T>(DoublyLinkedList<T> list, DoublyLinkedListNode<T> startNode, DoublyLinkedListNode<T> endNode, DoublyLinkedListNode<T> nodeAfterEndNode, int depthRemaining, IComparer<T> comparer)
        {
        ...
        /// <summary>
        /// Sequential algorithm. In-place sorting of the given <see cref="DoublyLinkedList{T}"/> elements. Used for ascending sort.
        /// </summary>
        /// <typeparam name="T">The data type of the <see cref="DoublyLinkedList{T}"/>.</typeparam>
        /// <param name="list">The <see cref="DoublyLinkedList{T}"/> containing the elements for sorting.</param>
        /// <param name="startNode">The start <see cref="DoublyLinkedListNode{T}"/> of the current split.</param>
        ...
        /// <param name="nodeAfterEndNode">The <see cref="DoublyLinkedListNode{T}"/> which is the node after the sorted sequence.</param>
        /// <param name="comparer">The <see cref="IComparable{T}"/> implementation used for comparing the elements.</param>
        private static void SequentialSplitMerge<T>(DoublyLinkedList<T> list, DoublyLinkedListNode<T> startNode, DoublyLinkedListNode<T> endNode, DoublyLinkedListNode<T> nodeAfterEndNode, IComparer<T> comparer)
        {
            // End of recursion. If we have 1 item or less we consider it sorted
            if (list.Count < 2) return;
        ...
        /// <summary>
        /// Parallel algorithm. In-place sorting of the given <see cref="DoublyLinkedList{T}"/> elements. Used for descending sort.
        /// </summary>
        /// <typeparam name="T">The data type of the <see cref="DoublyLinkedList{T}"/>.</typeparam>
        /// <param name="list">The <see cref="DoublyLinkedList{T}"/> containing the elements for sorting.</param>
        /// <param name="startNode">The start <see cref="DoublyLinkedListNode{T}"/> of the current split.</param>
        ...
        /// <param name="depthRemaining">The remaining depth of the recursion for which parallel tasks are invoked.</param>
        /// <param name="comparer">The <see cref="IComparable{T}"/> implementation used for comparing the elements.</param>
        private static void ParallelSplitMergeDescending<T>(DoublyLinkedList<T> list, DoublyLinkedListNode<T> startNode, DoublyLinkedListNode<T> endNode, DoublyLinkedListNode<T> nodeAfterEndNode, int depthRemaining, IComparer<T> comparer)
        {
            // End of recursion. If we have 1 item or less we consider it sorted
            if (list.Count < 2) return;
