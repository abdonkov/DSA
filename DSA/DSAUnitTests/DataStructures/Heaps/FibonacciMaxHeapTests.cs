...
{
    [TestClass]
    public class FibonacciMaxHeapTests
    {
        [TestMethod]
        public void AddingElementsAndCheckingIfExtractedInSortedOrder()
        {
            var heap = new FibonacciMaxHeap<int>();
        ...
        {
            var heap1 = new FibonacciMaxHeap<int>();
            var heap2 = new FibonacciMaxHeap<int>();
            ...
            var oldHeap1 = new FibonacciMaxHeap<int>();
            oldHeap1.Heapify(heap1.ToArray());

            var oldHeap2 = new FibonacciMaxHeap<int>();
        ...
        [TestMethod]
        public void ConvertingToFibonacciMinHeap()
        {
            var maxHeap = new FibonacciMaxHeap<int>();
            ...
            // Fibonacci min heap heapified from the max heap. Has to be the same
            // as the converted min heap
            var heapifiedMinHeap = new FibonacciMinHeap<int>();
