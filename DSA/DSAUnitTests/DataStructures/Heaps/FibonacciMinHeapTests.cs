...
namespace DSAUnitTests.DataStructures.Heaps
{
    ...
    public class FibonacciMinHeapTests
    {
        ...
        public void AddingElementsAndCheckingIfExtractedInSortedOrder()
        {
            ...
            int maxHeapElement = 2;
            int minHeapElement = -2;
        ...
        public void MergingTwoHeapsAndCheckingIfExtractedInSortedOrder()
        {
            ...
            var heap2 = new FibonacciMinHeap<int>();
            ...
            var oldHeap1 = new FibonacciMinHeap<int>();
            oldHeap1.Heapify(heap1.ToArray());

            var oldHeap2 = new FibonacciMinHeap<int>();
        ...
        public void ConvertingToFibonacciMaxHeap()
        {
            ...
            // Fibonacci max heap heapified from the min heap. Has to be the same
            // as the converted max heap
            var hepifiedMaxHeap = new FibonacciMaxHeap<int>();

            hepifiedMaxHeap.Heapify(minHeap.ToArray());

            var maxHeap = minHeap.ToMaxHeap();

            if (maxHeap.Count != hepifiedMaxHeap.Count) Assert.Fail();
            ...
            {
                if (max1 < hepifiedMaxHeap.PeekMax()) Assert.Fail();
